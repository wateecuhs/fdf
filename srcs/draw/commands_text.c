...
/*   Updated: 2023/12/08 17:08:03 by panger           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_cmds_txt(t_vars *vars)
{
	...
	mlx_string_put(vars->mlx, vars->win, WIDTH + 10,
		270, 0xF2BAC9, "R/T: Rotate around X axis");
	mlx_string_put(vars->mlx, vars->win, WIDTH + 10,
		290, 0xF2BAC9, "F/G: Rotate around Y axis");
	mlx_string_put(vars->mlx, vars->win, WIDTH + 10,
		310, 0xF2BAC9, "V/B: Rotate around Z axis");
	mlx_string_put(vars->mlx, vars->win, WIDTH + 10,
		330, 0xF2BAC9, "Z/X: Change Z-axis coefficient");
	mlx_string_put(vars->mlx, vars->win, WIDTH + 10,
		350, 0xF2BAC9, "O/P: Zoom in/out");
	mlx_string_put(vars->mlx, vars->win, WIDTH + 10,
		370, 0xF2BAC9, "Q  : Reset");
}
